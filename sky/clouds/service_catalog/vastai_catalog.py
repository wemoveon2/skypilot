"""VastAI service catalog.

This module loads the service catalog file and can be used to
query instance types and pricing information for VastAI.
"""
...
_df = common.read_catalog("vastai/vms.csv")
...
def validate_region_zone(
    ...
    if zone is not None:
        with ux_utils.print_exception_no_traceback():
            raise ValueError("VastAI does not support zones.")
    return common.validate_region_zone_impl("vastai", _df, region, zone)
...
def list_accelerators(
    ...
    """Returns all instance types in VastAI offering GPUs."""
